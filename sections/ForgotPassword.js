...
const ForgotPassword = () => {
    ...
    const sendVerificationEmail = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post(`localhost:3001/api/email`, {
                email: email
            });
    ...
    const verifyEmail = async () => {
        setLoading(true);
        try {
            const response = await axios.post(`localhost:3001/api/verify`, {
                email: email,
    ...
    const handleResetPassword = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.put(`localhost:3001/api/reset-password`, {
                email: email,
